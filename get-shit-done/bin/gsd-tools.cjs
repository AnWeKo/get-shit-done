 ...
 *   roadmap unplanned                  List phases with no plans and not complete
 ...
 *   init plan-all                      All context for plan-all workflow
    ...
    case 'init': {
      ...
      switch (workflow) {
        ...
        case 'progress':
          ...
          break;
        default:
          error(`Unknown init workflow: ${workflow}\nAvailable: execute-phase, plan-phase, plan-all, new-project, new-milestone, quick, resume, verify-work, phase-op, todos, milestone-op, map-codebase, progress`);
      }
      break;
    }
